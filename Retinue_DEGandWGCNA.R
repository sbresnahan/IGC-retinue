...
# batch <- as.integer(model.matrix(~subspecies,metadata_new)[,2])
# dds.transform <- ComBat_seq(as.matrix(dds.transform),batch=batch)
...
### WGCNA
##### blocks 1-3 | signed 15 | 1 module correlated with phenotype
